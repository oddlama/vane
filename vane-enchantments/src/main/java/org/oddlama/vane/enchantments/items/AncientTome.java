...
public class AncientTome extends CustomItem<Enchantments, AncientTome> {
	public static class AncientTomeVariant extends CustomItemVariant<Enchantments, AncientTome, SingleVariant> {
		public AncientTomeVariant(AncientTome parent, SingleVariant variant) {
	...
	public AncientTome(Context<Enchantments> context) {
		super(context, AncientTomeVariant::new);
	}
}
