...
public class RegionPlexMapLayer extends ModuleComponent<Regions> {
...
//	public TranslatedMessage lang_marker_label;
	...
	private RegionPlexMapLayerDelegate delegate = null;

	public RegionPlexMapLayer(final Context<Regions> context) {
		super(
				context.group("plexmap", "Enable Pl3xMap integration. Regions will then be shown on a separate Pl3xMap layer.")
		);
	}
	...
	public void delayed_on_enable() {
		...
		delegate = new RegionPlexMapLayerDelegate(this);
