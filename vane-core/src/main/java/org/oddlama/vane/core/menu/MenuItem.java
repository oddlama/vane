...
public class MenuItem implements MenuWidget {
	...
	public MenuItem(int slot, final ItemStack item) { this(slot, item, (Function4<Player, Menu, MenuItem, InventoryClickEvent, ClickResult>)null); }
	...
	public MenuItem(int slot, final ItemStack item, final Function4<Player, Menu, MenuItem, InventoryClickEvent, ClickResult> on_click) {
		this.slot = slot;
