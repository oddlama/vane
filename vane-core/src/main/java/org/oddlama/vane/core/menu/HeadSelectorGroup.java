...
public class HeadSelectorGroup extends ModuleComponent<Core> {
	...
	@LangMessage public TranslatedMessage lang_filter_title;
	...
	public HeadSelectorGroup(Context<Core> context) {
        ...
        item_select_head = new TranslatedItemStack<>(get_context(), "select_head", Material.BARRIER, 1, "Used to represent a head in the head library.");
	}
